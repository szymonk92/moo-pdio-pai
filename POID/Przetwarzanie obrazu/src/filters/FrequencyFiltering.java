            ...
            for (int j = 0; j < h; ++j) {
                if (i < image.getWidth() && j < image.getHeight()) {
                    ...
                    if (raster.getNumBands() == 3) {
                        if (filterNo < 5) {
                            if ( test<1)
                                System.out.print("zapodaje standard:"+(test++));
...
//                        + "p1(" + p1.getX() + "," + p1.getY() + ") p2(" + p2.getX() + "," + p2.getY() + ")");
                transformedImage[0] = FFTTools.edgeDetecionFilter(transformedImage[0], params[0], params[1], params[2], params[3], p1, p2);
                break;
            case 5:
        ...
        if (additionalImages[1]) {
            ...
            magnImgData = FFTTools.magnitudeImage(transformedImage[0]);
        ...
        if (additionalImages[0]) {
            ...
            phaseImgData = FFTTools.phaseImage(transformedImage[0]);
