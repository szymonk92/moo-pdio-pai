...
public class SegmentationWindow extends javax.swing.JFrame implements PropertyChangeListener {
    ...
    private void initComponents() {
        ...
        pixelCompererPanelLayout.setVerticalGroup(
            ...
            .addGroup(pixelCompererPanelLayout.createSequentialGroup()
                .addContainerGap()
                .addGroup(pixelCompererPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(valueLabel)
                    .addComponent(jSlider1, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
    ...
    private void processButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_processButtonActionPerformed
        ...
        quadTree.setPixelComperer(new SimplePixelComparer(this.jSlider1.getValue()));
        int value = 0;
        try {
            value = Integer.parseInt(this.minPixelTextField.getText());
