...
\subsection{Segmentacja}
 \begin{figure}[H]
  \centering
  \subfloat[Metoda Euklidesowa. Maski:11]{
    \label{fig_wyniki:seg_bird1}
	  \includegraphics[width=0.42\textwidth]{img/seg/mask/bird/Simple21_2000_11}
  }
  \subfloat[Porównanie jasności. Maski:4]{
    \label{fig_wyniki:seg_bird2}
  		\includegraphics[width=0.42\textwidth]{img/seg/mask/bird/Luminace21_2000_4}
  	}
