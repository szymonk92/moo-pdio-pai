 ...
 * @author Lukasz
 */
public class MLPAnalyser implements Analyser {
    ...
    private List<Rectangle> classify(List<Rectangle> regions) {
        ...
        try {
            Classifier classify = (Classifier) SerializationHelper.read(MLPAnalyser.class.getResource("mlp.model").getPath());
            ObjectInputStream oi = new ObjectInputStream(new BufferedInputStream(new FileInputStream(MLPAnalyser.class.getResource("mlp.features").getPath())));
            ...
            Logger.getLogger(ThreadProcesor.class.getName()).log(Level.SEVERE, null, e);
        } catch (IOException e) {
            Logger.getLogger(ThreadProcesor.class.getName()).log(Level.SEVERE, null, e);
